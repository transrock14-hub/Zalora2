...
interface MerchantAgreementClientProps {
  page: {
    title: string
    content: string
  }
...
export function MerchantAgreementClient({ page }: MerchantAgreementClientProps) {
  return (
    <div className="flex flex-col min-h-screen bg-background pb-20 lg:pb-0">
      ...
      <div className="bg-primary px-4 pt-4 pb-6 lg:hidden">
        <div className="flex items-center justify-between">
          ...
          <h1 className="text-white text-lg font-bold font-heading">Merchant Agreement</h1>
      ...
      <div className="hidden lg:block container mx-auto px-4 py-6">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h1 className="text-2xl font-bold font-heading">Merchant Agreement</h1>
        </div>
      </div>
      ...
      <div className="flex-1 px-4 lg:container lg:mx-auto">
        <div className="max-w-4xl mx-auto py-8">
          ...
          <div className="mt-8 bg-gradient-to-r from-primary to-primary/80 rounded-xl p-8 text-center text-white">
            <h2 className="text-2xl font-bold mb-4">Ready to Become a Merchant?</h2>
            <p className="mb-6 opacity-90">
              Join thousands of successful sellers on ZALORA Fashion
            </p>
